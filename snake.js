...
document.addEventListener('keydown', event => {
	if (!gameActive || directionChanged) return;
	...
	if (key === 'ArrowLeft' && direction !== oppositeDirections['LEFT']) {
		direction = 'LEFT';
		directionChanged = true;
	}
	if (key === 'ArrowUp' && direction !== oppositeDirections['UP']) {
		direction = 'UP';
		directionChanged = true;
	}
	if (key === 'ArrowRight' && direction !== oppositeDirections['RIGHT']) {
		direction = 'RIGHT';
		directionChanged = true;
	}
	if (key === 'ArrowDown' && direction !== oppositeDirections['DOWN']) {
		direction = 'DOWN';
		directionChanged = true;
	}
});
